...
router.route('/').post(authenticate,authorize(["admin"]),upload.single('image'),[ body('name').notEmpty().withMessage("Name is required")] ,createCategory).get(getAllCategories)
